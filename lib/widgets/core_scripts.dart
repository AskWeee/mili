...
class _CoreScriptsState extends State<CoreScripts> {
  ...
  final List<Map> _commands = [
    ...
    },
    {
      ...
      "dir": '',
      "title": "显示Pod（anolisosapp）中第一个容器的操作系统版本信息"
    },
    {
      "cmd": 'uname',
      "arguments": ['-a'],
    ...
    {
      "cmd": 'kubectl',
      "arguments": ['get', 'pods', 'anolisosapp', '-o', 'jsonpath="{}"', '-n', 'default'],
      "dir": '',
      "title": "显示Pod详情信息"
    },
    {
      "cmd": 'kubectl',
      "arguments": ['exec', 'anolisosapp', '--', 'yum', 'repolist', '--all'],
      "dir": '',
      "title": "显示Pod第一个容器的yum源详情信息"
    },
  ];
